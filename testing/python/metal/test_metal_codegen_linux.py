...
def test_metal_gemm_codegen_float32():
    assert_metal_gemm_codegen(64, 64, 64, 16, 16, 16)


def test_metal_gemm_codegen_float16():
    assert_metal_gemm_codegen(64, 64, 64, 16, 16, 16, dtype=T.float16, accum_dtype=T.float32)


def test_metal_gemm_codegen_large():
    assert_metal_gemm_codegen(1024, 1024, 1024, 16, 16, 16)
